...
const PublisherDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-secondary/10 via-primary/5 to-accent/10 py-12">
        <div className="max-w-7xl mx-auto px-6">
          <nav className="flex items-center gap-2 text-sm text-text-muted mb-6">
            ...
            <span>/</span>
            <span className="text-text font-medium">Publisher Dashboard</span>
          </nav>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-text-muted text-lg">
                Welcome, {user?.email?.split("@")[0] || "Publisher"}! Manage
                your books and upload new titles.
              </p>
            </div>
            <button
              onClick={() => navigate("/upload")}
              className="inline-flex items-center gap-2 bg-primary text-white px-6 py-3 rounded-xl font-medium hover:bg-primary/90 transition-colors shadow-lg shadow-primary/30"
            >
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-surface rounded-xl p-4 border border-primary/10">
            ...
            <p className="text-text-muted text-sm">Added This Week</p>
          </div>
          <Link
            to="/upload"
          ...
          >
            ...
            <p className="text-text-muted text-sm">Add a new book</p>
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link
            to="/upload"
            className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-xl p-6 border border-primary/20 hover:shadow-lg transition-all group"
          >
